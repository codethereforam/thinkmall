$(document).ready(function () {
    ...
    $(".nav-sidebar-body .nav li a").each(function () {
        ...
        $(this).attr("href", "#" + convertedUrl);
        contentInMainContent += '<div id="' + convertedUrl + '" class="tab-pane fade">\n' +
            '                <iframe class="main-iframe" src="' + BASE_PATH + url + '" width="100%" frameborder="0"' +
